...
4. Pass the adapter conformance kit (Milestone 2 — until it lands, mirror the
...
- Branch from `main`; open a PR with a [Changeset](https://github.com/changesets/changesets)
  (`pnpm changeset`) for anything user-facing.
- CI must pass: lint, typecheck, tests on Node 20/22/24.
